...
import { GET_POKEMONS, GET_POKEID, GET_POKENAME, GET_TYPES, POST_POKEMON, POKEMON_TYPE, ORDER_NAME, ORDER_ATTACK, FILTER_CREATED, CLEAR_PAGE, LOADING} from "./const";
...
export const getPokemonName = (name) => { 
    return async function(dispatch){
        ...
        return dispatch({
            ...
            return dispatch({ type: GET_POKENAME, payload: {err: err.response.data.msg}})
        }
